...
function Element:get_visibility()
	...
	-- a curtain that draws nothing must not hide the elements underneath it either.
	local curtain_is_visible = Elements.curtain.opacity > 0 and config.opacity.curtain > 0
	local min_order = (curtain_is_visible and not self.ignores_curtain) and Elements.curtain.render_order or 0
